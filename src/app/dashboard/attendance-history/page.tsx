...
export default function AttendanceHistory() {
 ...
 // Function to trigger download in WebView-compatible way
 ...
 // Function to download attendance data as PDF (WebView Compatible)
 const handleDownloadPDF = async () => {
   ...
   try {
     ...
     // Generate PDF blob for WebView compatibility
     const pdfBlob = pdfDoc.output('blob');
     const fileName = `Laporan_Kehadiran_${format(new Date(), "yyyyMMdd_HHmmss")}.pdf`;

     // Trigger download using WebView-compatible method
 ...
 // Function to download attendance data as Excel (WebView Compatible)
 const handleDownloadExcel = async () => {
   ...
   try {
     ...
     // Generate Excel blob for WebView compatibility
     ...
     // Trigger download using WebView-compatible method
     triggerDownload(excelBlob, fileName, 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
